...
//	private void validateProfile(UserRequestDto userDto) throws InvalidRequestException {
//		if (ObjectUtils.isEmpty(userDto.getProfile()) || !StringUtils.hasLength(userDto.getProfile().getEmail())) {
//			throw new InvalidRequestException("Email is required");
//		}
//	}
//
//	private void validateCredentials(UserRequestDto userDto) throws InvalidRequestException {
//		if (ObjectUtils.isEmpty(userDto.getCredentials())
//				|| !StringUtils.hasLength(userDto.getCredentials().getUsername())) {
