...
INSERT INTO tweet(content, deleted, posted, author_id, repost_of_id, in_reply_to_id, id)
VALUES ('test tweet InReplyTo content', false, '2020-11-06 11:02:10-08', (select id from users where username='test2'), null, (SELECT last_value-1 FROM tweet_id_seq), nextval('tweet_id_seq'));
INSERT INTO tweet(content, deleted, posted, author_id, repost_of_id, in_reply_to_id, id)
VALUES ('test tweet InReplyTo content', false, '2020-11-06 11:033:10-08', (select id from users where username='test2'), null, (SELECT last_value-1 FROM tweet_id_seq), nextval('tweet_id_seq'));
INSERT INTO tweet(content, deleted, posted, author_id, repost_of_id, in_reply_to_id, id)
VALUES ('test tweet InReplyTo content', false, '2020-11-06 11:04:10-08', (select id from users where username='test2'), null, (SELECT last_value-1 FROM tweet_id_seq), nextval('tweet_id_seq'));
INSERT INTO tweet(content, deleted, posted, author_id, repost_of_id, in_reply_to_id, id)
VALUES ('test tweet InReplyTo content', false, '2020-11-06 11:05:10-08', (select id from users where username='test2'), null, (SELECT last_value-1 FROM tweet_id_seq), nextval('tweet_id_seq'));
INSERT INTO tweet(content, deleted, posted, author_id, repost_of_id, in_reply_to_id, id)
VALUES ('test tweet InReplyTo content', false, '2020-11-06 11:06:10-08', (select id from users where username='test2'), null, (SELECT last_value-1 FROM tweet_id_seq), nextval('tweet_id_seq'));
INSERT INTO tweet(content, deleted, posted, author_id, repost_of_id, in_reply_to_id, id)
VALUES ('test tweet InReplyTo content', false, '2020-11-06 11:07:10-08', (select id from users where username='test2'), null, (SELECT last_value-2 FROM tweet_id_seq), nextval('tweet_id_seq'));
INSERT INTO tweet(content, deleted, posted, author_id, repost_of_id, in_reply_to_id, id)
VALUES ('test tweet InReplyTo content', false, '2020-11-06 11:08:10-08', (select id from users where username='test2'), null, (SELECT last_value-3 FROM tweet_id_seq), nextval('tweet_id_seq'));
INSERT INTO tweet(content, deleted, posted, author_id, repost_of_id, in_reply_to_id, id)
VALUES ('test tweet InReplyTo content', false, '2020-11-06 11:09:10-08', (select id from users where username='test2'), null, (SELECT last_value-5 FROM tweet_id_seq), nextval('tweet_id_seq'));
