...
application. The application will be managed in a simulated kan ban agile style and will make use of Github issues and the project board. 
...
application.Friday afternoon students will present their final projects as a tech-demo for the "stakeholders" of the application.
